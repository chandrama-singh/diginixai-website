...
<form class="form-style-two" id="enquiry-form" action>
<input type="hidden" name="location" value="Enquery Form">
<div class="row">
<div class="col-md-6">
