...
<div class="col-md-5">
<div class="banner-image-wrap"><img src="~/assets/Restaurant_Hospitality.png" alt="Restaurant_Hospitality"></div>
</div>
</div>
</div>
</section>
...
<div class="card text-center">
      <div class="card-body">
        ...
        <p class="card-text">
          Looking to improvise on existing Hospitality Operations with Smart Mobility Solutions?
          </p>
      </div>
