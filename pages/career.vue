...
<div class="container">
<h1>Career</h1>
<h3>We are looking for Phenomenal people, who are willing to join industries' leading team.</h3>
</div>
</div>
</div>
</section>

<section class="emizentech-career">
<div class="container">
...
<h3><span>No of poisition : 4</span> <span>Location : Jaipur, Rajasthan</span></h3>
</div>
<div class="col-md-4 text-md-right">
<a href="mailto:hr@emizentech.com" class="emizentech-btn">Apply Now</a>
</div>
</div>
<h4>We're a team of Certified Magento developers who develop quality, user-friendly and scalable Magento websites. We are looking for the same who devotes full love and passion for E-Commerce.</h4>
</div>
<div class="career-info">
<div class="career-info-inner" id="career1">
<h3>Key responsibilities :</h3>
<ul class="bullet-list">
<li>Must have worked on minimum 2-3 projects of Magento.</li>
<li>Magento 2 Framework understanding</li>
<li>Good Experience with SI integration like CRM,CMS,ERP,SAP etc</li>
<li>Very strong with REST &amp; other Magento web service implementations &amp; customizations</li>
<li>Magento 1 to Magento 2 Migrations</li>
<li>Magento Theme designing</li>
...
<h4>Qualification</h4>
<p>B.Tech. (Any Specialization)/ <br> M.Tech. (Any Specialization)/ MCA</p>
</div>
</div>
<div class="col-md-4">
<div class="career-meta-item">
<h4>Experience</h4>
<p>At least 1 year or more than that.</p>
</div>
</div>
<div class="col-md-4">
<div class="career-meta-item">
<h4>Salary</h4>
<p>Negotiable (As per the Interview and experience)</p>
</div>
</div>
</div>
</div>
</div>
<div class="career-btn"><a href="JavaScript:void(0)" data-text-swap="- Less" class="career1">+ Expand</a></div>
</div>
</div>
<div class="career-item-wrap">
<div class="career-item">
...
<div class="col-md-8">
<h2>PHP Developer</h2>
<h3><span>No of poisition : 2</span> <span>Location : Jaipur, Rajasthan</span></h3>
</div>
<div class="col-md-4 text-md-right">
<a href="mailto:hr@emizentech.com" class="emizentech-btn">Apply Now</a>
</div>
</div>
<h4>We are Hiring PHP Developer with skills mentioned below:</h4>
</div>
<div class="career-info">
<div class="career-info-inner" id="career2">
<h3>Key responsibilities :</h3>
<ul class="bullet-list">
<li>Expertise in Core PHP, Cake PHP, WordPress, PHP 5, MySQL, JavaScript, Ajax, HTML, CSS, Jquery.</li>
<li>Should be able to develop and structure databases.</li>
<li>Able to understand project requirement and handle project</li>
<li>Should have expertise on PHP5 /should have good knowledge of Oops</li>
<li>Should have knowledge of CURL, SOAP and REST API (GET &amp; POST)</li>
<li>Should have experienced with complex SQL queries , database schema design,SQL stored procedure and other db optimization technique</li>
<li>Should have knowledge of Ajax and APIs integration ie. Google API, Facebook API, third party affiliates etc. are highly desirable.</li>
</ul>
<div class="career-meta">
<div class="row">
<div class="col-md-4">
...
<div class="career-btn"><a href="JavaScript:void(0)" data-text-swap="- Less" class="career2">+ Expand</a></div>
</div>
</div>
<div class="career-item-wrap">
<div class="career-item">
...
<h4>We are looking for a Wordpress Developer to work for offshore clients around the world and manage projects effectively.</h4>
</div>
<div class="career-info">
<div class="career-info-inner" id="career3">
<h3>Key responsibilities :</h3>
<ul class="bullet-list">
<li>Core PHP</li>
<li>OOPS</li>
...
<div class="career-btn"><a href="JavaScript:void(0)" data-text-swap="- Less" class="career3">+ Expand</a></div>
</div>
</div>
<div class="career-item-wrap">
<div class="career-item">
...
<h4>Hiring a passionate Designer to create a dynamic web designs using their creative thoughts.</h4>
</div>
<div class="career-info">
<div class="career-info-inner" id="career4">
<h3>Key responsibilities :</h3>
<ul class="bullet-list">
<li>HTML, HTML5</li>
<li>Bootstrap</li>
...
<div class="career-btn"><a href="JavaScript:void(0)" data-text-swap="- Less" class="career4">+ Expand</a></div>
</div>
</div>
</div>
</section>
