...
<h1>Small Scale Business Industry</h1>
<p>Essentially small scale industries comprise of small enterprises who manufacture goods or services with the help of relatively smaller machines and a few workers and employees. These industries make a one-time investment in machinery, plants, and industries, but it does not exceed Rs 1 Crore.
</p>
...
<div class="col-md-5">
<div class="banner-image-wrap"><img src="~/assets/ssi.png" alt="ssi"></div>
</div>
</div>
</div>
</section>
...
<div class="card text-center">
      <div class="card-body">
        ...
        <p class="card-text">
          Your goal is our goal as we focus on prevention and proactivity. We help manage all aspect of your IT needs, so you don’t have to give a second thought. Our team works round-the-clock to ensure that your technology is secure and reliable, even when you are sleeping. So, rather estimating how many tickets we cleared and how many hours we billed, we estimate how happy you are with our services.
          </p>
      </div>
